...
export default class StatisticMont extends Component {
    constructor(props) {
        super(props);
        this.state = {
        ...
        return (
            ...
            >
                <View style={styles.container}>
                    <Text style={{ marginBottom: 20, fontSize: 18 }}>Thống kê dinh dưỡng của những thực phẩm bạn và gia đình tiêu thụ trong tháng.</Text>
